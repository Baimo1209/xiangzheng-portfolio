export const articles = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "课程包括波兰语言与文化、信息技术、网络安全、应用物理和人工智能等。文化课使用卡片、提问和小组讨论，大家需要用英语回答和交流。",
      "网络安全课上，老师的英语口音让我一开始有些跟不上。听不清的地方，我结合课件和上下文理解，课后再和同学核对。专业词汇认识，但听到时未必能马上反应过来，这是这次听课遇到的一个实际问题。",
      "期间参访了维拉诺夫宫、克拉科夫和奥斯维辛—比克瑙集中营等地点。英语导游配合耳机讲解，介绍建筑、展品和相关历史。日常问路和购物时，也会借助简单英语、地图和手势沟通。",
      "回国后整理了实习日记和访学汇报材料。这次主要是短期学习和交流，没有参与企业岗位工作。",
    ],
  },
  {
