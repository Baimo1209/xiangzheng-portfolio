...
export default function About() {
  return <SiteShell>
    ...
    <section className="bento about-bento">
      ...
      <article className="bento-cell cell-image"><div className="banner-media"><img src={`${basePath}/bg.jpg`} alt="网站背景" /></div><div className="banner-text"><strong>项征</strong><span>个人博客与项目记录</span></div></article>
