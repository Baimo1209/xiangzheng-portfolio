...
export default function About() {
  return <SiteShell>
    <section className="page-hero compact"><span>About Me</span><h1 className="gradient-text">关于我</h1><p>教育背景与研究兴趣。</p></section>
    <section className="bento about-bento">
      ...
      <article className="bento-cell cell-image"><div className="banner-media"><img src={`${basePath}/portrait.jpg`} alt="项征的人像照片" /></div><div className="banner-text"><strong>项征</strong><span>个人博客与项目记录</span></div></article>
